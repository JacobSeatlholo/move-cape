...
<style>{`@import url('https://fonts.googleapis.com/css2?family=Syne:wght@700;800;900&family=DM+Sans:wght@300;400;500;600;700;800&display=swap'); *{box-sizing:border-box;margin:0;padding:0;} ::-webkit-scrollbar{width:0} input{outline:none;background:transparent;border:none;color:#e8f0ff;font-family:inherit;} input::placeholder{color:#374060;} a{transition:opacity 0.2s;} @keyframes fadeUp{from{opacity:0;transform:translateY(16px)}to{opacity:1;transform:translateY(0)}} @keyframes fadeIn{from{opacity:0}to{opacity:1}} @keyframes dotPulse{0%,100%{opacity:1;transform:scale(1)}50%{opacity:0.3;transform:scale(0.7)}} @keyframes glowPulse{0%,100%{box-shadow:0 0 20px rgba(0,255,204,0.2),0 4px 16px rgba(0,0,0,0.4)}50%{box-shadow:0 0 40px rgba(0,255,204,0.5),0 4px 20px rgba(0,0,0,0.5)}} @keyframes spin{from{transform:rotate(0deg)}to{transform:rotate(360deg)}} @keyframes scanPulse{0%,100%{opacity:0.6}50%{opacity:1}} .rc{animation:fadeUp 0.4s cubic-bezier(.4,0,.2,1) both;} .rc:nth-child(1){animation-delay:0.05s}.rc:nth-child(2){animation-delay:0.12s}.rc:nth-child(3){animation-delay:0.19s} .sug:hover{background:rgba(0,255,204,0.06)!important;} .navbtn:hover{color:#00ffcc!important;} .qp:hover{background:rgba(0,255,204,0.06)!important;border-color:rgba(0,255,204,0.2)!important;} .ql:hover{color:#00ffcc!important;border-color:rgba(0,255,204,0.3)!important;}`}</style>
